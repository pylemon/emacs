...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (rst-level-1-face ((t (:foreground "#66D9EF"))))
     (rst-level-2-face ((t (:foreground "#F92672" :background "#000000"))))
     (rst-level-3-face ((t (:foreground "#A6E22E" :background "#000000"))))
     (rst-level-4-face ((t (:foreground "#AE81FF" :background "#000000"))))
     (rst-level-5-face ((t (:foreground "#E6DB74" :background "#000000"))))
